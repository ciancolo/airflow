...
class TableauRefreshDatasourceOperator(BaseOperator):
    ...
    def execute(self, context: dict) -> str:
        ...
        with TableauHook(self.site_id, self.tableau_conn_id) as tableau_hook:
            ...
            job_id = self._refresh_datasource(tableau_hook, datasource)
            if self.blocking:
    ...
    def _refresh_datasource(self, tableau_hook: TableauHook, datasource: DatasourceItem) -> str:
        job = tableau_hook.server.datasources.refresh(datasource)
